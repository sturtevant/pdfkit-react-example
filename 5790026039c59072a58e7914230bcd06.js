    ...
    "/../../jshint/node_modules/underscore/underscore.js": [function (_dereq_, module, exports) {
      (function (global) {
        (function (global, factory) {
          typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define('underscore', factory) : function () {
      ...
      var JSHINT = function () {
        ...
        infix("(", function (context, left, that) {
          ...
          if (typeof left === "object") {
            ...
            if (!left.identifier && left.id !== "." && left.id !== "[" && left.id !== "=>" && left.id !== "(" && left.id !== "&&" && left.id !== "||" && left.id !== "?" && left.id !== "async" && !(state.inES6() && left["(name)"])) {
              warning("W067", that);
            }
          }
        ...
        prefix("(", function (context, rbp) {
          ...
          if (ret.id === ",") {
            ...
            if (!isNecessary) {
              ...
              isNecessary = opening.beginsStmt && (ret.id === "{" || triggerFnExpr) || triggerFnExpr && (!isEndOfExpr() || state.tokens.prev.id !== "}") || ret.id === "=>" && !isEndOfExpr() || ret.id === "{" && preceeding.id === "=>" || beginsUnaryExpression(ret) && state.tokens.next.id === "**" || ret.type === "(number)" && checkPunctuator(pn, ".") && /^\d+$/.test(ret.value) || opening.beginsStmt && ret.id === "=" && ret.left.id === "{";
            }
          }
        ...
        blockstmt("function", function (context) {
          ...
          if (nameToken && (f["(name)"] === "arguments" || f["(name)"] === "eval") && enablesStrictMode) {
        ...
        prefix("function", function (context) {
          ...
          var nameToken = optionalidentifier(isAsync ? context | prodParams.async : context) ? state.tokens.curr : null;
          var f = doFunction(context, {
            name: nameToken && nameToken.value,
            type: generator ? "generator" : null
          });
          ...
          if (nameToken && (f["(name)"] === "arguments" || f["(name)"] === "eval") && f["(isStrict)"]) {
            error("E008", nameToken);
          }
      ...
      Lexer.prototype = {
        ...
        token: function token() {
          ...
          var create = function (type, value, isProperty, token) {
            ...
            if (type === "(identifier)") {
              if (value === "return" || value === "case" || value === "yield" || value === "typeof" || value === "instanceof" || value === "void" || value === "await") {
                this.prereg = true;
              }
    ...
    "/../../jshint/src/scope-manager.js": [function (_dereq_, module, exports) {
      ...
      var scopeManager = function scopeManager(state, predefined, exported, declared) {
        ...
        var scopeManagerInst = {
          ...
          setExported: function setExported(bindingName, token) {
